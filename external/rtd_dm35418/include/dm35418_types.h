/**
    ...
    $Id: dm35418_types.h 127189 2020-09-16 13:22:33Z lfrankenfield $
*/
...
#ifndef __DM35418_TYPES_H__
#define __DM35418_TYPES_H__

/**
 * @defgroup DM35418_General_Definitions DM35418 Board Types
 * @{
 */
 ...
 */
#define DM35418_SUBTYPE_00	0

/**
 * @brief
 *     Constant for FB subtype 1
 */
#define DM35418_SUBTYPE_01	1

/**
 * @brief
 *     Constant for FB subtype 2
 */
#define DM35418_SUBTYPE_02	2

/**
 * @brief
 *     Constant for FB subtype 3
 */
#define DM35418_SUBTYPE_03	3
...
*/
#define DM35418_SUBTYPE_INVALID 0xFF

/**
 * @brief
 *     Constant value indicating an invalid function block
 */
#define DM35418_FUNC_BLOCK_INVALID	0x0000

/**
 * @brief
 *     Constant value indicating an invalid function block
 */
#define DM35418_FUNC_BLOCK_INVALID2	0xFFFF

/**
 * @brief
 *     Function Block Constant for SyncBus
 */
#define DM35418_FUNC_BLOCK_SYNCBUS			0x0001

/**
 * @brief
 *     Function Block Constant for Global Clocking
 */
#define DM35418_FUNC_BLOCK_EXT_CLOCKING		0x0002

/**
 * @brief
 *     Function Block Constant for External Clocking (0003)
 */
#define DM35418_FUNC_BLOCK_CLK0003			0x0003

/**
 * @brief
 * 	Function Block Constant for Capture Window
 */
#define DM35418_FUNC_BLOCK_CAPTWIN		0x0005

/**
 * @brief
 *     Function Block Constant for ADC
 */
#define DM35418_FUNC_BLOCK_ADC			0x1000
 ...
 */
#define DM35418_DMA_MAX_BUFFER_SIZE			0xFFFFFC
 ...
 */
#define DM35418_BOARD_ACK_INTERRUPT	0x1

/**
 * @brief
 *      Value to write to the Reset register in order to reset the board.
 */
#define DM35418_BOARD_RESET_VALUE	0xAA
 ...
 *      read/write access.
 */
#define DM35418_FIFO_ACCESS_FB_REVISION 0x01

/**
 * @} DM35418_General_Definitions
 */
